...
'1'::bigint, '1999-04-21'::date, '454645687'::bigint, 'jjty'::character varying(255), 'ergergerger'::character varying(255))

INSERT INTO public.person (
id, birth_date, document_number, document_type, name) VALUES (
'2'::bigint, '1999-04-21'::date, '456456455'::bigint, 'jjty'::character varying(255), 'ergergerger'::character varying(255))


INSERT INTO public.credential (
id, date_of_expiry, date_of_issue, id_didi_credential, id_didi_issueer, id_didi_receptor, beneficiary_id, id_credential) VALUES (
'1'::bigint, '2020-03-28'::timestamp without time zone, '2020-03-28'::timestamp without time zone, '1'::bigint, '1'::bigint, '1'::bigint, '1'::bigint, '1'::bigint)

INSERT INTO public.credential (
id, date_of_expiry, date_of_issue, id_didi_credential, id_didi_issueer, id_didi_receptor, beneficiary_id, id_credential) VALUES (
'2'::bigint, '2020-03-28'::timestamp without time zone, '2020-03-28'::timestamp without time zone, '2'::bigint, '2'::bigint, '2'::bigint, '1'::bigint, '2'::bigint)
