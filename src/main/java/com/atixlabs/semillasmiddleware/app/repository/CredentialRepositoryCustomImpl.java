...
public class CredentialRepositoryCustomImpl implements CredentialRepositoryCustom {
    ...
    @Override
    public List<Credential> findCredentialsWithFilter(String credentialType, String name, String dniBeneficiary, String dniHolder, String idDidiCredential, String lastUpdate, List<String> credentialStates,  Pageable page) {
